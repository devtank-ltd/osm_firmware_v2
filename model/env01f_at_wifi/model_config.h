...
#define UART_1_SPEED        9600    /* OSM_EXAMPLE_RS232 */
...
typedef struct
{
    ...
    /* 7 x 16 bytes          */
} osm_persist_model_config_v3_t;

OSM_STATIC_ASSERT_16BYTE_ALIGNED(osm_persist_model_config_v3_t, modbus_bus);
OSM_STATIC_ASSERT_16BYTE_ALIGNED(osm_persist_model_config_v3_t, comms_config);
OSM_STATIC_ASSERT_16BYTE_ALIGNED(osm_persist_model_config_v3_t, cc_configs);
OSM_STATIC_ASSERT_16BYTE_ALIGNED(osm_persist_model_config_v3_t, ios_state);
OSM_STATIC_ASSERT_16BYTE_ALIGNED(osm_persist_model_config_v3_t, sai_cal_coeffs);
