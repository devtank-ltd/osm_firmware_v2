...
STATIC_ASSERT_16BYTE_ALIGNED(persist_model_config_v3_t, modbus_bus);
STATIC_ASSERT_16BYTE_ALIGNED(persist_model_config_v3_t, comms_config);
STATIC_ASSERT_16BYTE_ALIGNED(persist_model_config_v3_t, cc_configs);
STATIC_ASSERT_16BYTE_ALIGNED(persist_model_config_v3_t, ios_state);
STATIC_ASSERT_16BYTE_ALIGNED(persist_model_config_v3_t, sai_cal_coeffs);
