...
#include "env01c_config.h"
#include "env01c.h"

static bool _write_json_from_img_env01c(struct json_object * root, void * model_config_raw)
{
    persist_env01c_config_v1_t* model_config = (persist_env01c_config_v1_t*)model_config_raw;
...
static bool _read_json_to_img_env01c(struct json_object * root, void * model_config_raw)
{
    persist_env01c_config_v1_t* model_config = (persist_env01c_config_v1_t*)model_config_raw;
    ...
    env01c_measurements_add_defaults(osm_mem.measurements->measurements_arr);
...
void __attribute__((constructor)) env01c_register_config(void);


void env01c_register_config(void)
{
    static struct model_config_funcs_t model_config_funcs = {ENV01C_MODEL_NAME,
                                                             sizeof(persist_env01c_config_v1_t),
                                                             _write_json_from_img_env01c,
                                                             _read_json_to_img_env01c,
                                                             NULL};
