...
env01g_at_wifi_SOURCES := \
    ...
    $(OSM_MODEL_DIR)/env01g_at_wifi/model.c

env01g_at_wifi_LINK_SCRIPT := $(OSM_DIR)/src/ports/stm/stm32l4.ld

$(eval $(call STM_FIRMWARE,env01g_at_wifi))
