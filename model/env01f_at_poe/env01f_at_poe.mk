...
env01f_at_poe_SOURCES := \
           ...
           $(OSM_MODEL_DIR)/env01f_at_poe/model.c \
           $(OSM_MODEL_DIR)/env01f_at_poe/model_config_update.c \
...
env01f_at_poe_LINK_SCRIPT := $(OSM_DIR)/ports/stm/stm32l4.ld

$(eval $(call STM_FIRMWARE,env01f_at_poe))
