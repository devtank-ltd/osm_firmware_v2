env01c_at_wifi_SOURCES := \
           ...
           $(MODEL_DIR)/env01c_at_wifi/env01c_at_wifi.c \
...
env01c_at_wifi_LINK_SCRIPT := $(OSM_DIR)/ports/stm/stm32l4.ld

$(eval $(call STM_FIRMWARE,env01c_at_wifi))
