...
env01g_at_poe_SOURCES := \
    ...
    $(OSM_MODEL_DIR)/env01g_at_poe/model.c

env01g_at_poe_LINK_SCRIPT := $(OSM_DIR)/src/ports/stm/stm32l4.ld

$(eval $(call STM_FIRMWARE,env01g_at_poe))
