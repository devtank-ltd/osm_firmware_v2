...
typedef enum
{
    ...
    MEASUREMENTS_SEND_TYPE_INT8    = 1 | VALUE_TYPE_IS_SIGNED,
    MEASUREMENTS_SEND_TYPE_INT16   = 2 | VALUE_TYPE_IS_SIGNED,
    MEASUREMENTS_SEND_TYPE_INT32   = 3 | VALUE_TYPE_IS_SIGNED,
    MEASUREMENTS_SEND_TYPE_INT64   = 4 | VALUE_TYPE_IS_SIGNED,
    MEASUREMENTS_SEND_TYPE_FLOAT   = 5 | VALUE_TYPE_IS_SIGNED,
