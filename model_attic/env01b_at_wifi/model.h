...
extern void     model_persist_config_model_init(persist_model_config_v1_t * config);
extern bool     model_persist_config_cmp(persist_model_config_v1_t* d0, persist_model_config_v1_t* d1);
...
extern void     model_debug_mode_enable_all(void);
