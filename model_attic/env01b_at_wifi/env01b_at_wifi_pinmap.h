...
#define ENV01B_AT_WIFI_ADCS_PORT_N_PINS                      \
{                                                   \
...
#define ENV01B_AT_WIFI_ADC1_CHANNEL_CURRENT_CLAMP_1    6
#define ENV01B_AT_WIFI_ADC1_CHANNEL_CURRENT_CLAMP_2   16
#define ENV01B_AT_WIFI_ADC1_CHANNEL_CURRENT_CLAMP_3    9
#define ENV01B_AT_WIFI_ADC1_CHANNEL_BAT_MON            1
#define ENV01B_AT_WIFI_ADC1_CHANNEL_3V3_RAIL_MON       3
#define ENV01B_AT_WIFI_ADC1_CHANNEL_5V_RAIL_MON        4

#define ENV01B_AT_WIFI_ADC_DMA_CHANNELS                                                  \
{                                                                               \
    { ADC1, DMA1, RCC_DMA1, NVIC_DMA1_CHANNEL1_IRQ, DMA_CHANNEL1, ADC_PRIORITY  , true } , /* ADC1 */   \
}

#define ENV01B_AT_WIFI_ADC_DMA_CHANNELS_COUNT  1

#define ENV01B_AT_WIFI_ADC_COUNT       6
...
#define ENV01B_AT_WIFI_COMMS_RESET_PORT_N_PINS     { GPIOC, GPIO8 }
...
#define ENV01B_AT_WIFI_UART_CHANNELS                                                                                             \
{                                                                                                                       \
