...
typedef enum
{
    ...
    SENxx_MODEL_SEN54  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN5x) | SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_RH_T,
    SENxx_MODEL_SEN55  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN5x) | SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_RH_T | SENxx_MODEL_MEASUREMENT(SENxx_MEASUREMENT_VOC),
