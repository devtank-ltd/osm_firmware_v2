...
#define SENxx_MODEL_HAS_MEASUREMENT(_m, _r) (((_m >> SENxx_MODEL_MEASUREMENT_SHIFT_C) & SENxx_MODEL_MEASUREMENT_MASK) & _r)

#define SENxx_MEASUREMENT_PM                    (                       \
    SENxx_MEASUREMENT_PM1_0                     |                       \
    SENxx_MEASUREMENT_PM2_5                     |                       \
    SENxx_MEASUREMENT_PM4                       |                       \
    SENxx_MEASUREMENT_PM10                )
...
{
    SENxx_MODEL_NONE   = 0,
    SENxx_MODEL_SEN50  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN5x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM)),
    SENxx_MODEL_SEN54  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN5x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_RH_T)),
    SENxx_MODEL_SEN55  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN5x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_RH_T | SENxx_MEASUREMENT_VOC)),
    SENxx_MODEL_SEN60  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN6x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM)),
    SENxx_MODEL_SEN63C = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN6x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_CO2)),
    SENxx_MODEL_SEN65  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN6x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_RH_T | SENxx_MEASUREMENT_VOC | SENxx_MEASUREMENT_NOX)),
    SENxx_MODEL_SEN66  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN6x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_RH_T | SENxx_MEASUREMENT_VOC | SENxx_MEASUREMENT_NOX | SENxx_MEASUREMENT_CO2)),
    SENxx_MODEL_SEN68  = SENxx_MODEL_FAMILY(SENxx_FAMILY_SEN6x) | SENxx_MODEL_MEASUREMENT((SENxx_MEASUREMENT_PM | SENxx_MEASUREMENT_RH_T | SENxx_MEASUREMENT_VOC | SENxx_MEASUREMENT_NOX | SENxx_MEASUREMENT_HCHO)),
} senxx_model_t;
