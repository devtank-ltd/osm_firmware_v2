...
mkdir -p /tmp/osm_gui_bundle

tar -czvf /tmp/osm_gui_bundle/osm_gui_bundle.tar.gz config_gui ../config_database/ ../firmware_imgs/complete.bin ../stm32flash ../yaml_files/ ../osm_pictures/ ../docs/config_gui_manual.pdf ../README.md

echo "=================================================="
echo "Bundle : /tmp/osm_gui_bundle/osm_gui_bundle.tar.gz"
echo "=================================================="
