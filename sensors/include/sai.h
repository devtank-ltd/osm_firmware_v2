...
extern measurements_sensor_state_t  sai_measurements_init(char* name, bool in_isolation);
extern measurements_sensor_state_t  sai_measurements_get(char* name, measurements_reading_t* value);
