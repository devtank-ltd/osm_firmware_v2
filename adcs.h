...
extern bool     adcs_cc_begin(char* name);
extern bool     adcs_cc_collect(char* name, value_t* value);
extern bool     adcs_cc_get(char* name, value_t* value);
...
extern bool     adcs_bat_begin(char* name);
extern bool     adcs_bat_get(char* name, value_t* value);
